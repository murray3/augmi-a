...
response.menu.append(('My Augmi',False,URL(request.application,'default','my_augmi')))
response.menu.append(('Login', False, auth.settings.login_url))
response.menu.append(('More?', False,URL(request.application,'default','more')))
##########################################
