...
routes_in=(('/$args', '/init/default/profile/$args'),
  #('/$args/(?P<any>.*$)', '/init/default/profile/$args/\g<any>'),
  ('.*:/favicon.ico', '/examples/static/favicon.ico'),
  ('.*:/robots.txt', '/examples/static/robots.txt'))
  
routes_out=(('/init/default/profile/$args', '/$args'))
  #('/init/default/profile/$args/\g<any>', '/$args/(?P<any>.*$)')) 
